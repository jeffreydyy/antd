...
export const asyncRouterMap = [

  {
    ...
    meta: { title: '首页' },
    redirect: '/checkstand/checkstand',
    children: [
      // dashboard
      {
        path: '/dashboard',
        ...
        component: RouteView,
        meta: { title: '仪表盘', keepAlive: true, icon: 'dollar', permission: [ 'dashboard' ] },
        children: [
          {
      ...
      {
        path: '/checkstand',
        // component: () => import('@/views/checkstand/Checkstand'),
        name: 'checkstand',
        component: RouteView,
        hideChildrenInMenu: true,
        meta: { title: '收银台', icon: 'dollar', permission: [ 'dashboard' ] },
        redirect: '/checkstand/Checkstand',
        children: [
          {
            path: '/checkstand/Checkstand',
            name: 'checkstand',
            hidden: true,
            component: () => import('@/views/checkstand/Checkstand'),
            meta: { title: '收银台', keepAlive: true, permission: [ 'dashboard' ] }
          }
        ]
      }
    ]
